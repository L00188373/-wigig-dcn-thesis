...
/* Print comparison with wired technologies */
    std::cout << "\n╔════════════════════════════════════════════════════════╗" << std::endl;
    std::cout << "║      Comparison with Wired Technologies               ║" << std::endl;
    std::cout << "╚════════════════════════════════════════════════════════╝\n" << std::endl;
    
    std::cout << "Technology          Throughput    Latency    Packet Loss    Cabling" << std::endl;
    std::cout << "─────────────────────────────────────────────────────────────────────" << std::endl;
    std::cout << "Cat5/6 Ethernet     1,000 Mbps    <1 ms      <0.01%         Required" << std::endl;
    std::cout << "60 GHz WiGig        2,700 Mbps    60-90 ms   ~70%           None" << std::endl;
    std::cout << "10G Fiber           10,000 Mbps   <0.5 ms    <0.01%         Required" << std::endl;
    std::cout << "\nKey Findings:" << std::endl;
    std::cout << "  • WiGig provides 2.7x the speed of Cat6 Ethernet" << std::endl;
    std::cout << "  • WiGig achieves 27% of 10G Fiber performance" << std::endl;
    std::cout << "  • No physical cabling required for WiGig" << std::endl;
    std::cout << "  • Best use: Backup links, flexible connections, temporary deployments\n" << std::endl;
