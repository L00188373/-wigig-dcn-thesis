 ...
 * - ToR 1 & 2: Wired only (10 Gbps links)
 * - ToR 3 & 4: Hybrid (10 Gbps wired + WiGig wireless backup)
...
int main(int argc, char *argv[])
{
    ...
    SimConfig config;
    Metrics uniformMetrics, hotspotMetrics;
    ...
    // Connect ToR switches to spine switches
    for (uint32_t tor = 0; tor < config.numToRSwitches; tor++) {
    ...
    NS_LOG_INFO("(WiGig implementation pending - showing baseline)");
